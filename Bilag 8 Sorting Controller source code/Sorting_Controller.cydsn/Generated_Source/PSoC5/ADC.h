...
#define ADC_ACFG_RESOLUTION         (16u )
#define ADC_ACFG_INPUT_RANGE        (4u)
#define ADC_ACFG_SRATE              (10000u)
#define ADC_ACFG_REFERENCE          (0u)
#define ADC_ACFG_BUFFER_GAIN        (1u)
#define ADC_ACFG_CONV_MODE          (2u)
#define ADC_ACFG_INPUT_RANGE_VALUE  (1.024)
...
/* Actuator config
* ADC_ACFG Sample Rate: 10000 Samples per Second
* ADC_ACFG Conversion Mode: 2
* ADC_ACFG Input Buffer Gain: 1
* ADC_ACFG Reference: 0
* ADC_ACFG Input Range: 4
* ADC_ACFG Resolution: 16 bits
* ADC_ACFG Clock: 640000 Hz
*/

#define ADC_ACFG_DEC_CR             (0x38u)
#define ADC_ACFG_DEC_SR             (0x14u)
#define ADC_ACFG_DEC_SHIFT1         (0x04u)
#define ADC_ACFG_DEC_SHIFT2         (0x07u)
#define ADC_ACFG_DEC_DIV            (0)
#define ADC_ACFG_DEC_DR2            (0x00u)
#define ADC_ACFG_DEC_DR2H           (0x00u)
#define ADC_ACFG_DEC_DR1            (0x3Fu)
#define ADC_ACFG_DEC_OCOR           (0x00u)
#define ADC_ACFG_DEC_OCORM          (0x00u)
#define ADC_ACFG_DEC_OCORH          (0x00u)
#define ADC_ACFG_DEC_GVAL           (0x0Fu)
#define ADC_ACFG_DEC_GCOR           (0x00u)
#define ADC_ACFG_DEC_GCORH          (0x00u)
#define ADC_ACFG_DEC_COHER          (0x01u)
#define ADC_ACFG_DSM_CR0            (0x0Au)
#define ADC_ACFG_DSM_CR1            (0x00u)
#define ADC_ACFG_DSM_CR2            (0x7Au)
#define ADC_ACFG_DSM_CR3            (0x00u)
#define ADC_ACFG_DSM_CR4            (0x50u)
#define ADC_ACFG_DSM_CR5            (0x27u)
#define ADC_ACFG_DSM_CR6            (0x2Cu)
#define ADC_ACFG_DSM_CR7            (0x00u)
#define ADC_ACFG_DSM_CR8            (0x5Bu)
#define ADC_ACFG_DSM_CR9            (0x5Eu)
#define ADC_ACFG_DSM_CR10           (0x55u)
#define ADC_ACFG_DSM_CR11           (0x5Au)
#define ADC_ACFG_DSM_CR12           (0x05u)
#define ADC_ACFG_DSM_CR13           (0x00u)
#define ADC_ACFG_DSM_CR14           (0x01u)
#define ADC_ACFG_DSM_CR15           (0x11u)
#define ADC_ACFG_DSM_CR16           (0x19u)
#define ADC_ACFG_DSM_CR17           (0x97u)
#define ADC_ACFG_DSM_REF0           (0x44u)
#define ADC_ACFG_DSM_REF1           (0x00u)
#define ADC_ACFG_DSM_REF2           (0x58u)
#define ADC_ACFG_DSM_REF3           (0x00u)
#define ADC_ACFG_DSM_DEM0           (0x04u)
#define ADC_ACFG_DSM_DEM1           (0x00u)
#define ADC_ACFG_DSM_MISC           (0x00u)
#define ADC_ACFG_DSM_CLK            (0x18u)
#define ADC_ACFG_DSM_BUF0           (0x05u)
#define ADC_ACFG_DSM_BUF1           (0x01u)
#define ADC_ACFG_DSM_BUF2           (0x00u)
#define ADC_ACFG_DSM_BUF3           (0x0Au)
#define ADC_ACFG_DSM_OUT0           (0x00u)
#define ADC_ACFG_DSM_OUT1           (0x00u)
#define ADC_ACFG_DSM_SW3            (0x00u)
#define ADC_ACFG_CLOCKS_PER_SAMPLE  (0x0040u)
#define ADC_ACFG_CLOCK_FREQ         (640000u)
#define ADC_ACFG_CP_CLOCK_FREQ      (4000000u)
#define ADC_ACFG_REFERENCE_VOLTAGE  (1.0240)
#define ADC_ACFG_COUNTS_PER_VOLT    (32000)
#define ADC_ACFG_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_ACFG_IDEAL_ODDDEC_GAIN  (0x8000u)

#define ADC_ACFG_ALIGNMENT          (0u)
#define ADC_ACFG_ADC_CLK_DIVIDER    (37u)
#define ADC_ACFG_CP_CLK_DIVIDER     (5u)

/* Input and DAC Cap values in pF */
#define ADC_ACFG_IPCAP1VALUE        (0x0F30u)
#define ADC_ACFG_DACAPVALUE         (0x1130u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_DEFAULT_SRATE                      ADC_ACFG_SRATE
#define ADC_CLOCKS_PER_SAMPLE                  ADC_ACFG_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ                    ADC_ACFG_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE                  ADC_ACFG_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT               ADC_ACFG_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION                 ADC_ACFG_RESOLUTION
#define ADC_DEFAULT_CONV_MODE                  ADC_ACFG_CONV_MODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN             ADC_ACFG_IDEAL_DEC_GAIN
#define ADC_DEFAULT_RANGE                      ADC_ACFG_RANGE
#define ADC_DEFAULT_RANGE_VALUE                ADC_ACFG_RANGE_VALUE
#define ADC_DEFAULT_REFERENCE                  ADC_ACFG_REFERENCE
#define ADC_DEFAULT_BUF_GAIN                   ADC_ACFG_BUF_GAIN
#define ADC_ACFG_BUF_GAIN           ADC_ACFG_BUFFER_GAIN
#define ADC_ACFG_RANGE              ADC_ACFG_INPUT_RANGE
#define ADC_ACFG_RANGE_VALUE        ADC_ACFG_INPUT_RANGE_VALUE

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE                ADC_ACFG_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE                 ADC_ACFG_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN          ADC_ACFG_IDEAL_ODDDEC_GAIN


/* Default register settings for the Config 2 */
/* Weight config
* ADC_WCFG Sample Rate: 10000 Samples per Second
* ADC_WCFG Conversion Mode: 2
* ADC_WCFG Input Buffer Gain: 1
* ADC_WCFG Reference: 0
* ADC_WCFG Input Range: 4
* ADC_WCFG Resolution: 16 bits
* ADC_WCFG Clock: 640000 Hz
*/

#define ADC_WCFG_DEC_CR             (0x38u)
#define ADC_WCFG_DEC_SR             (0x14u)
#define ADC_WCFG_DEC_SHIFT1         (0x04u)
#define ADC_WCFG_DEC_SHIFT2         (0x07u)
#define ADC_WCFG_DEC_DIV            (0)
#define ADC_WCFG_DEC_DR2            (0x00u)
#define ADC_WCFG_DEC_DR2H           (0x00u)
#define ADC_WCFG_DEC_DR1            (0x3Fu)
#define ADC_WCFG_DEC_OCOR           (0x00u)
#define ADC_WCFG_DEC_OCORM          (0x00u)
#define ADC_WCFG_DEC_OCORH          (0x00u)
#define ADC_WCFG_DEC_GVAL           (0x0Fu)
#define ADC_WCFG_DEC_GCOR           (0x00u)
#define ADC_WCFG_DEC_GCORH          (0x00u)
#define ADC_WCFG_DEC_COHER          (0x01u)
#define ADC_WCFG_DSM_CR0            (0x0Au)
#define ADC_WCFG_DSM_CR1            (0x00u)
#define ADC_WCFG_DSM_CR2            (0x7Au)
#define ADC_WCFG_DSM_CR3            (0x00u)
#define ADC_WCFG_DSM_CR4            (0x50u)
#define ADC_WCFG_DSM_CR5            (0x27u)
#define ADC_WCFG_DSM_CR6            (0x2Cu)
#define ADC_WCFG_DSM_CR7            (0x00u)
#define ADC_WCFG_DSM_CR8            (0x5Bu)
#define ADC_WCFG_DSM_CR9            (0x5Eu)
#define ADC_WCFG_DSM_CR10           (0x55u)
#define ADC_WCFG_DSM_CR11           (0x5Au)
#define ADC_WCFG_DSM_CR12           (0x05u)
#define ADC_WCFG_DSM_CR13           (0x00u)
#define ADC_WCFG_DSM_CR14           (0x01u)
#define ADC_WCFG_DSM_CR15           (0x11u)
#define ADC_WCFG_DSM_CR16           (0x19u)
#define ADC_WCFG_DSM_CR17           (0x97u)
#define ADC_WCFG_DSM_REF0           (0x44u)
#define ADC_WCFG_DSM_REF2           (0x58u)
#define ADC_WCFG_DSM_REF3           (0x00u)
#define ADC_WCFG_DSM_DEM0           (0x04u)
#define ADC_WCFG_DSM_DEM1           (0x00u)
#define ADC_WCFG_DSM_BUF0           (0x05u)
#define ADC_WCFG_DSM_BUF1           (0x01u)
#define ADC_WCFG_DSM_BUF2           (0x00u)
#define ADC_WCFG_DSM_BUF3           (0x0Au)
#define ADC_WCFG_DSM_OUT0           (0x00u)
#define ADC_WCFG_DSM_OUT1           (0x00u)
#define ADC_WCFG_DSM_SW3            (0x00u)
#define ADC_WCFG_SRATE              (10000u )
#define ADC_WCFG_CLOCKS_PER_SAMPLE  (0x0040u)
#define ADC_WCFG_CLOCK_FREQ         (640000u)
#define ADC_WCFG_CP_CLOCK_FREQ      (4000000u)
#define ADC_WCFG_REFERENCE_VOLTAGE  (1.0240)
#define ADC_WCFG_COUNTS_PER_VOLT    (32000)
#define ADC_WCFG_RESOLUTION         (16u)
#define ADC_WCFG_CONV_MODE          (2u)
#define ADC_WCFG_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_WCFG_INPUT_RANGE        (4u)
#define ADC_WCFG_INPUT_RANGE_VALUE  (1.024)

#define ADC_WCFG_REFERENCE          (0u)
#define ADC_WCFG_BUFFER_GAIN        (1u)
#define ADC_WCFG_ALIGNMENT          (0u)
#define ADC_WCFG_ADC_CLK_DIVIDER    (37u)
#define ADC_WCFG_CP_CLK_DIVIDER     (5u)

/* Input and DAC Cap values in pF */
#define ADC_WCFG_IPCAP1VALUE        (0x0F30u)
#define ADC_WCFG_DACAPVALUE         (0x1130u)
#define ADC_WCFG_IDEAL_ODDDEC_GAIN  (0x8000u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_WCFG_CONVMODE           ADC_WCFG_CONV_MODE
#define ADC_WCFG_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
#define ADC_DEFAULT_SRATE_CFG2                 ADC_WCFG_SRATE
#define ADC_CLOCKS_PER_SAMPLE_CFG2             ADC_WCFG_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ_CFG2               ADC_WCFG_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE_CFG2             ADC_WCFG_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT_CFG2          ADC_WCFG_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION_CFG2            ADC_WCFG_RESOLUTION
#define ADC_CONVMODE_CFG2                      ADC_WCFG_CONVMODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN_CFG2        ADC_WCFG_IDEAL_DEC_GAIN
#define ADC_DEFAULT_INPUT_RANGE_CFG2           ADC_WCFG_INPUT_RANGE
#define ADC_DEFAULT_INPUT_RANGE_VALUE_CFG2     ADC_WCFG_INPUT_RANGE_VALUE
#define ADC_DEFAULT_INPUT_MODE_CFG2            ADC_WCFG_INPUT_MODE
#define ADC_DEFAULT_REFERENCE_CFG2             ADC_WCFG_REFERENCE
#define ADC_DEFAULT_BUFFER_GAIN_CONFIG2        ADC_WCFG_BUFFER_GAIN

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE_CFG2           ADC_WCFG_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE_CFG2            ADC_WCFG_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN_CFG2     ADC_WCFG_IDEAL_ODDDEC_GAIN
