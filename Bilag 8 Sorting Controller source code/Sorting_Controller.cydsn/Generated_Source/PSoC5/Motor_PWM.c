...
void Motor_PWM_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(Motor_PWM_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 Motor_PWM_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(Motor_PWM_CAPTURE_LSB_PTR));
    }
...
void Motor_PWM_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(Motor_PWM_PERIOD_LSB_PTR, period);
    #endif /* (Motor_PWM_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(Motor_PWM_COMPARE1_LSB_PTR, compare);
        #endif /* (Motor_PWM_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(Motor_PWM_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (Motor_PWM_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(Motor_PWM_COMPARE2_LSB_PTR, compare);
        #endif /* (Motor_PWM_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(Motor_PWM_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(Motor_PWM_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(Motor_PWM_COMPARE1_LSB_PTR));
        #endif /* (Motor_PWM_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(Motor_PWM_COMPARE2_LSB_PTR));
    }
...
{
    #if(Motor_PWM_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(Motor_PWM_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(Motor_PWM_PERIOD_LSB_PTR));
    #endif /* (Motor_PWM_UsingFixedFunction) */
}
